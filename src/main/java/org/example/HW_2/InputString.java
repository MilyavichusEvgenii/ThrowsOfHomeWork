...
public class InputString implements ServiceData{
    Scanner in;
    @Override
    public String[] inputData(String message) throws MyNullStringException, MySizeArrayException {
        System.out.println(message);
        Scanner in = new Scanner(System.in);
        String mes = in.nextLine();
        String[] result;
        if (mes == ""){
            throw new MyNullStringException();
        } else {
            result = mes.split(" ");
        }
        if (result.length != 6) {
